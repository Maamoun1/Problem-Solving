...
using namespace std;
/*
write a program to read a period and calculate a period length n days ?
*/
...
int main()
{
	...
	cout << "\nPeriod Length " << PeriodLenghInDays(Period1);

	cout << "\nPeriod Length (Encluding End date) is: " <<
		PeriodLenghInDays(Period1, true);
